...
# source_file_reader = PdfReader('Simpson MS..pdf')
# # weekly_reader = PdfReader('Weekly literature hits PDF.pdf')
    ...
    try:
        ...
        if title_of_page and len(title_of_page.split()) > 2:
            ...
            if num_words == 2:
                ...
                first_name = name_parts[0].lstrip()
                last_name = name_parts[1].lstrip()
            elif num_words == 1:
                first_name = name_parts[0].lstrip()
            elif num_words >= 3:
                first_name = name_parts[0].lstrip()
                middle_name = name_parts[1].lstrip()
                last_name = " ".join(name_parts[2:]).lstrip()
            ...
            print(last_name)
            # Address
            if "Michela" == first_name:
                print("yes 1")
            elif " Michela" == first_name:
                print("second yes")
            elif "Michela " == first_name:
                print("third yes")
            primary_reporter = ""
            ...
            if correspondence_start is not None:
                ...
                print("corr_text_split", correspondence_text.split())
            ...
            text_up_to_doi = ""
            cleaned_text = ""
            print("here fisrt name", first_name)
            print("here second", last_name)
            if correspondence_start is None:
                ...
                pattern_for_address = re.compile(r'(,\s){2,}')

                address_1 = re.sub(pattern_for_address, ', ', address)
                ...
                for line in lines:
                    if 'Tel' in line:
                        ...
                        if numbers_with_plus:
                            phone_number = ''.join(numbers_with_plus)
                        elif numbers_with_plus_in_brackets:
                            phone_number = ''.join(numbers_with_plus_in_brackets)
                        elif numbers_with_plus_in_brackets_and_space:
                            phone_number = ''.join(numbers_with_plus_in_brackets_and_space)
                ...
                # Find text after 'Affiliations'
                print("text_up_to_doi", text_up_to_doi)
                if 'Affiliation' in text_up_to_doi:
                    affiliation_text = text_up_to_doi.split('Affiliation')[1]
                else:
                    affiliation_text = text_up_to_doi.split('Affiliations')[1]
                ...
                for i, line in enumerate(text_lines):
                    if "Author" in line or "Authors" in line:
                        ...
                        if not matched_author:
                            correspondence_text_no_periods = correspondence_text.replace('.', '')
                            for name in authors:
                                if name in correspondence_text_no_periods:
                                    print("correspondence text is", correspondence_text_no_periods)
                                    print("matched name is", name)
                                    matched_author = name
                                    break
                ...
                print("name_parts", name_parts_corr)
                ...
                # Join the address parts into a string
                address_correspondence = ' '.join(addresses)
                pattern_for_address = re.compile(r'(,\s){2,}')

                address_1_correspondence = re.sub(pattern_for_address, ', ', address_correspondence)
                ...
                for line in lines:
                    if 'Tel' in line:
                        ...
                        numbers_with_plus_in_brackets_and_space = re.findall(r'\(\+\d+\) \d+', line)
                        if numbers_with_plus:
                            phone_number_correspondence = ''.join(numbers_with_plus)
                        elif numbers_with_plus_in_brackets:
                            phone_number_correspondence = ''.join(numbers_with_plus_in_brackets)
                        elif numbers_with_plus_in_brackets_and_space:
                            phone_number_correspondence = ''.join(numbers_with_plus_in_brackets_and_space)
